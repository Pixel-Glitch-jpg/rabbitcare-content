# Forbidden foods: what your rabbit must never eat

Some foods that are harmless to us are **toxic** or **very bad** for rabbits. If
your rabbit eats one of these, contact a rabbit-savvy vet without delay.
...
It is not a poison like avocado, but it is **best avoided**: mostly water, little
value, and it can soften the droppings. Prefer **dark-leaf lettuces** (romaine, oak
leaf).
