...
## The number one need: foraging for food

In the wild, a rabbit spends most of its day **searching for food**. Rather than
giving everything in a bowl, **scatter** the hay and greens: hide them in a tunnel,
under a layer of hay, in a toilet roll or a paper bag. It will keep busy for hours.

## Good, safe ideas

- **Tunnels and hideaways**: with an **entrance and an exit** (a rabbit needs a way
...
- **Soft plastic** and **rubber**: swallowed, they can block the gut.
- **Treated, varnished or painted** wood, and toxic woods (stone-fruit trees like
  cherry, avocado). When in doubt, stick to the safe woods above.
